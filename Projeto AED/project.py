...
def cat():
    messagebox.showinfo("Ocorreu um erro","Pedimos desculpa, mas o Usuário tem esta categoria privada")
...
def loginWindow():
    ...
    label_utilizador.place(x = 20,y = 55)
    text_utilizador.place(x = 140,y = 60)

    #INSERIR A LABEL E A PALAVRA-PASSE DO UTILIZADOR

    label_passe.place(x=20,y=85)
    text_passe.place(x=140,y=90)

    #INSERIR BOTÕES DE LOGIN E CRIAR CONTA

    button_login.place(x = 350,y = 50)
    button_criarconta.place(x = 350,y = 90)
...
def Login():
    ...
    #CASO OS DADOS DE ACESSO ESTEJAM CORRETOS, EFETUA LOGIN
        ...
        if str(guardar_admin) in str(lista):
            messagebox.showinfo("Bem vindo ADMINISTRADOR","Bem vindo ADMIN")
...
label_menu = Label(window, text="MENU UTILIZADORES",fg = "black", bg="white", font=("Calibri 25 bold"), width = 30, height = 1)

#BOTÃO SAIR
button_sair = Button(window, text = "Fechar", fg = "red", font = ("Calibri", 12),width=10,height=1, command = window.quit)
...
#LABEL MENU PRINCIPAL
label_menu = Label(window, text="UTILIZADORES",fg = "black", bg="white", font=("Calibri 25 bold"), width = 30, height = 1)
...
def dora():
    ...
    #REMOVE AS IMAGENS DA DORA NATUREZA

    label_doranatureza.place_forget()
    label_doranatureza1.place_forget()
    label_doranatureza2.place_forget()
    label_doranatureza3.place_forget()
    label_doranatureza4.place_forget()

    label_doradesporto1.place_forget()
    label_doradesporto2.place_forget()
    label_doradesporto3.place_forget()
    label_doradesporto4.place_forget()
...
def doradesporto():
    ...
    label_doradesporto1.place(x=120, y=100)
    label_doradesporto2.place(x=480, y=100)
    label_doradesporto3.place(x=120, y=300)
    label_doradesporto4.place(x=480, y=300)
...
def doranatureza():
    ...
    #INSERE A IMAGEM
    label_doranatureza1.place(x=120, y=100)
    label_doranatureza2.place(x=480, y=100)
    label_doranatureza3.place(x=120, y=300)
    label_doranatureza4.place(x=480, y=300)
...
foto_doradesporto1 = ImageTk.PhotoImage(Image.open("doradesporto1.png"))
foto_doradesporto2 = ImageTk.PhotoImage(Image.open("doradesporto2.png"))
foto_doradesporto3 = ImageTk.PhotoImage(Image.open("doradesporto3.png"))
foto_doradesporto4 = ImageTk.PhotoImage(Image.open("doradesporto4.png"))
...
label_doradesporto1 = Label(window,text="",width = 310, height= 170, image=foto_doradesporto1)
label_doradesporto2 = Label(window,text="",width = 310, height= 170, image=foto_doradesporto2)
label_doradesporto3 = Label(window,text="",width = 310, height= 170, image=foto_doradesporto3)
label_doradesporto4 = Label(window,text="",width = 310, height= 170, image=foto_doradesporto4)
...
foto_doranatureza1 = ImageTk.PhotoImage(Image.open("doranatureza1.png"))
foto_doranatureza2 = ImageTk.PhotoImage(Image.open("doranatureza2.png"))
foto_doranatureza3 = ImageTk.PhotoImage(Image.open("doranatureza3.png"))
foto_doranatureza4 = ImageTk.PhotoImage(Image.open("doranatureza4.png"))



button_doranatureza = Button(window,text="",width = 375, height = 200,image = foto_doranatureza,command=doranatureza)
label_doranatureza = Label(window,text="",width = 375, height= 200, image=foto_doranatureza)
label_doranatureza1 = Label(window,text="",width = 310, height= 170, image=foto_doranatureza1)
label_doranatureza2 = Label(window,text="",width = 310, height= 170, image=foto_doranatureza2)
label_doranatureza3 = Label(window,text="",width = 310, height= 170, image=foto_doranatureza3)
label_doranatureza4 = Label(window,text="",width = 310, height= 170, image=foto_doranatureza4)

#doraarte
foto_doraarte = ImageTk.PhotoImage(Image.open("doraarte.png"))
button_doraarte=Button(window,text="",width = 375, height = 200,image = foto_doraarte,command=cat)

#SERRA DA doracarros
foto_doracarros = ImageTk.PhotoImage(Image.open("doracarros.png"))
button_doracarros=Button(window,text="",width = 375, height = 200,image = foto_doracarros,command=cat)
...
def manuel():
    ...
    #INSERE O NOME DE UTILIZADOR QUE ESTÁ AUTENTICADO
    user = text_utilizador.get()
    label_user = Label(window, text= f"Utilizador: {user}",fg="white",font = ("Calibri bold", 10),width=20,height=1,bg = "#C0C0C0")
    label_user.place(x=10,y=20)
    ...
    label_manuelnatureza1.place_forget()
    label_manuelnatureza2.place_forget()
    label_manuelnatureza3.place_forget()
    label_manuelnatureza4.place_forget()

    label_manuelcarros.place_forget()
    label_manuelcarros1.place_forget()
    label_manuelcarros2.place_forget()
    label_manuelcarros3.place_forget()
    label_manuelcarros4.place_forget()

    label_manueldesporto.place_forget()
    label_manueldesporto1.place_forget()
    label_manueldesporto2.place_forget()
    label_manueldesporto3.place_forget()
    label_manueldesporto4.place_forget()

    label_manuelarte.place_forget()
    label_manuelarte1.place_forget()
    label_manuelarte2.place_forget()
    label_manuelarte3.place_forget()
    label_manuelarte4.place_forget()
...
def manuelarte():
    ...
    #INSERE A IMAGEM
    label_manuelarte1.place(x=120, y=100)
    label_manuelarte2.place(x=480, y=100)
    label_manuelarte3.place(x=120, y=300)
    label_manuelarte4.place(x=480, y=300)
...
def manuelnatureza():
    ...
    #INSERE A IMAGEM
    label_manuelnatureza1.place(x=120, y=100)
    label_manuelnatureza2.place(x=480, y=100)
    label_manuelnatureza3.place(x=120, y=300)
    label_manuelnatureza4.place(x=480, y=300)
...
def manuelcarros():
    ...
    #INSERE A IMAGEM
    label_manuelcarros1.place(x=120, y=100)
    label_manuelcarros2.place(x=480, y=100)
    label_manuelcarros3.place(x=120, y=300)
    label_manuelcarros4.place(x=480, y=300)
...
def manueldesporto():
    ...
    label_manueldesporto1.place(x=120, y=100)
    label_manueldesporto2.place(x=480, y=100)
    label_manueldesporto3.place(x=120, y=300)
    label_manueldesporto4.place(x=480, y=300)
...
foto_manuelarte1 = ImageTk.PhotoImage(Image.open("manuelarte1.png"))
foto_manuelarte2 = ImageTk.PhotoImage(Image.open("manuelarte2.png"))
foto_manuelarte3 = ImageTk.PhotoImage(Image.open("manuelarte3.png"))
foto_manuelarte4 = ImageTk.PhotoImage(Image.open("manuelarte4.png"))
...
label_manuelarte1 = Label(window,text="",width = 310, height= 170, image=foto_manuelarte1)
label_manuelarte2 = Label(window,text="",width = 310, height= 170, image=foto_manuelarte2)
label_manuelarte3 = Label(window,text="",width = 310, height= 170, image=foto_manuelarte3)
label_manuelarte4 = Label(window,text="",width = 310, height= 170, image=foto_manuelarte4)

#manuelnatureza
foto_manuelnatureza = ImageTk.PhotoImage(Image.open("manuelnatureza.png"))
foto_manuelnatureza1 = ImageTk.PhotoImage(Image.open("manuelnatureza1.png"))
foto_manuelnatureza2 = ImageTk.PhotoImage(Image.open("manuelnatureza2.png"))
foto_manuelnatureza3 = ImageTk.PhotoImage(Image.open("manuelnatureza3.png"))
foto_manuelnatureza4 = ImageTk.PhotoImage(Image.open("manuelnatureza4.png"))
...
label_manuelnatureza1 = Label(window,text="",width = 310, height= 170, image=foto_manuelnatureza1)
label_manuelnatureza2 = Label(window,text="",width = 310, height= 170, image=foto_manuelnatureza2)
label_manuelnatureza3 = Label(window,text="",width = 310, height= 170, image=foto_manuelnatureza3)
label_manuelnatureza4 = Label(window,text="",width = 310, height= 170, image=foto_manuelnatureza4)

#manuelcarros
foto_manuelcarros = ImageTk.PhotoImage(Image.open("manuelcarros.png"))
foto_manuelcarros1 = ImageTk.PhotoImage(Image.open("manuelcarros1.png"))
foto_manuelcarros2 = ImageTk.PhotoImage(Image.open("manuelcarros2.png"))
foto_manuelcarros3 = ImageTk.PhotoImage(Image.open("manuelcarros3.png"))
foto_manuelcarros4 = ImageTk.PhotoImage(Image.open("manuelcarros4.png"))
...
label_manuelcarros1 = Label(window,text="",width = 310, height= 170, image=foto_manuelcarros1)
label_manuelcarros2 = Label(window,text="",width = 310, height= 170, image=foto_manuelcarros2)
label_manuelcarros3 = Label(window,text="",width = 310, height= 170, image=foto_manuelcarros3)
label_manuelcarros4 = Label(window,text="",width = 310, height= 170, image=foto_manuelcarros4)

#manueldesporto
foto_manueldesporto = ImageTk.PhotoImage(Image.open("manueldesporto.png"))
foto_manueldesporto1 = ImageTk.PhotoImage(Image.open("manueldesporto1.png"))
foto_manueldesporto2 = ImageTk.PhotoImage(Image.open("manueldesporto2.png"))
foto_manueldesporto3 = ImageTk.PhotoImage(Image.open("manueldesporto3.png"))
foto_manueldesporto4 = ImageTk.PhotoImage(Image.open("manueldesporto4.png"))
...
label_manueldesporto1 = Label(window,text="",width = 310, height= 170, image=foto_manueldesporto1)
label_manueldesporto2 = Label(window,text="",width = 310, height= 170, image=foto_manueldesporto2)
label_manueldesporto3 = Label(window,text="",width = 310, height= 170, image=foto_manueldesporto3)
label_manueldesporto4 = Label(window,text="",width = 310, height= 170, image=foto_manueldesporto4)

#TITULO: manuel
label_manuel = Label(window, text= "Manuel",fg = "black", bg="#C0C0C0", font=("Calibri 25 bold"), width = 30, height = 1)
...
def comentar_manuelnatureza():
    text_comentario.place(x=402,y=520, anchor=CENTER)
    button_comentar_manuelnatureza.place_forget()
    button_gosto_manuelnatureza.place_forget()
    button_ver_manuelnatureza.place_forget()
    button_submeter_manuelnatureza.place(x=795,y=520,anchor=CENTER)
...
text_comentario = Text(window,width=80,height=3)
...
def comentar_manuelcarros():
    ...
    button_gosto_manuelcarros.place_forget()
    button_ver_manuelcarros.place_forget()
    button_submeter_manuelcarros.place(x=795,y=520,anchor=CENTER)
...
def comentar_manuelarte():
    ...
    button_gosto_manuelarte.place_forget()
    button_ver_manuelarte.place_forget()
    button_submeter_manuelarte.place(x=795,y=520,anchor=CENTER)
...
def comentar_manueldesporto():
    ...
    button_gosto_manueldesporto.place_forget()
    button_ver_manueldesporto.place_forget()
    button_submeter_manueldesporto.place(x=795,y=520,anchor=CENTER)
...
def escolha_categorias():
    ...
    chk_carlos = Checkbutton(JanEscolha, text="carlos ", variable = chk_g)
    ...
    chk_angela = Checkbutton(JanEscolha, text="angela ", variable = chk_t)
